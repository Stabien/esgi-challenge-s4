...
func InitRouter(e *echo.Echo) {
	...
	e.PATCH("/events/:id/validate", middlewares.CheckUserRole(controllers.ValidateEvent, "admin"))
	e.PATCH("/events/:id/unvalidate", middlewares.CheckUserRole(controllers.UnvalidateEvent, "admin"))
